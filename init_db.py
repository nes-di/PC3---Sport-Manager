...
def insert_seed_data():
    ...
    for nom, poste, vitesse, endurance, force, technique in joueurs_ol:
        cursor.execute("""
    ...
    for nom, poste, vitesse, endurance, force, technique in joueurs_psg:
        cursor.execute("""
            INSERT INTO Joueur (id_equipe, nom, poste, vitesse, endurance, force, technique, duree_blessure)
            VALUES (?, ?, ?, ?, ?, ?, ?, 0)
        """, (id_psg, nom, poste, vitesse, endurance, force, technique))
    
    for nom, poste, vitesse, endurance, force, technique in joueurs_om:
        cursor.execute("""
            INSERT INTO Joueur (id_equipe, nom, poste, vitesse, endurance, force, technique, duree_blessure)
            VALUES (?, ?, ?, ?, ?, ?, ?, 0)
        """, (id_om, nom, poste, vitesse, endurance, force, technique))
    
    for nom, poste, vitesse, endurance, force, technique in joueurs_racing:
        cursor.execute("""
            INSERT INTO Joueur (id_equipe, nom, poste, vitesse, endurance, force, technique, duree_blessure)
            VALUES (?, ?, ?, ?, ?, ?, ?, 0)
        """, (id_racing, nom, poste, vitesse, endurance, force, technique))
